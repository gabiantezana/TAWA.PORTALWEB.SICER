<%@ Page Title="RendirReembolso" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="RendirReembolso.aspx.cs" Inherits="RendirReembolso" %>
...
<ContentTemplate>
 ...
 <br /> <asp:Label ID="lblIdReembolsoDocumento" runat="server" Visible="false"></asp:Label><asp:Label ID="lblIdProveedor" runat="server" Visible="false"></asp:Label>
 <table width="1008px">  
  <tr>
 ...
 <table width="1008px">
  ...
  <tr>
   <td align="left"><label>Moneda de Reembolso</label></td>
  ...
  <tr>
   ...
   <td align="left"><label>Importe Total Moneda R.E.</label></td>
   <td align="left">
 ...
 <center>
  ...
  <table>
   <tr>
    <td><asp:Button ID="bAgregar2" runat="server" OnClientClick="this.disabled = true; this.value = 'Procesando...';" UseSubmitBehavior="false" Text="Agregar" CssClass="button" onclick="Agregar2_Click" /></td>
    <td><asp:Button ID="bGuardar2" runat="server" OnClientClick="this.disabled = true; this.value = 'Procesando...';" UseSubmitBehavior="false" Text="Guardar" CssClass="button" onclick="Guardar2_Click" Visible="false" /></td>
   </tr>
  </table>
  <table width="100%">
   <tr>
 ...
 <table width="1008px">
  <tr>
   <td width="336px"></td>
   <td width="140px" align="right"><label>Fecha de Contabilizacion:</label></td>
   <td width="196px" align="left">
   ...
   <td align="center">
    <asp:GridView ID="gvReembolso" runat="server" 
     ...
     <Columns>
      ...
      <asp:TemplateField HeaderText="Editar" ItemStyle-HorizontalAlign="Center">
       <ItemTemplate>
        <asp:LinkButton ID="lnkEditar" runat="server" CommandName="Editar" CommandArgument='<%#Eval("IdReembolsoDocumento")%>' >
          <img src="img/edit.png" alt="Editar" width="20px" />
        </asp:LinkButton>
       </ItemTemplate>
      </asp:TemplateField>    
      <asp:TemplateField HeaderText="Eliminar" ItemStyle-HorizontalAlign="Center">
       <ItemTemplate>
        <asp:LinkButton ID="lnkEliminar" runat="server" CommandName="Eliminar" CommandArgument='<%#Eval("IdReembolsoDocumento")%>' > <img src="img/delete.png" alt="Editar" width="20px" /></asp:LinkButton>
       </ItemTemplate>
      </asp:TemplateField> 
      <asp:BoundField DataField="IdReembolsoDocumento" HeaderText="Id" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />   
      ...
      <asp:BoundField DataField="MontoTotal" HeaderText="Total RE" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />
 ...
 <table width="1008px">
  <tr>
    <td align="center"><asp:Button ID="bEnviar" runat="server" OnClientClick="this.disabled = true; this.value = 'Procesando...';" UseSubmitBehavior="false" Text="Enviar Rendicion" CssClass="button" onclick="Enviar_Click" /></td>
  </tr>
 </table>
 <table width="1008px" >
  <tr>
    <td align="center"><asp:Button ID="bAprobar" runat="server"  OnClick="Aprobar_Click"  OnClientClick="javascript: return ConfirmacionContabilizacion();" Text="Aprobar" CssClass="button"/>
    <asp:Button ID="bRechazar"    runat="server" OnClientClick="this.disabled = true; this.value = 'Procesando...';" UseSubmitBehavior="false" Text="Rechazar" CssClass="button" OnClick="Rechazar_Click" />
 ...
 <asp:GridView ID="gvReporte" runat="server"
  ...
  <Columns>
   ...
   <asp:BoundField DataField="MontoTotal" HeaderText="Total Reembolso" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" /> 
   <asp:TemplateField  HeaderText="Moneda" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
    <ItemTemplate><%# SetearMoneda(Convert.ToString(Eval("IdMonedaDoc")))%></ItemTemplate>
   </asp:TemplateField>
   <asp:BoundField DataField="MontoNoAfecto" HeaderText="No Afecto" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" /> 
