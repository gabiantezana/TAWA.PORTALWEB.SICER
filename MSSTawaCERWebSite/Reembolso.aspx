<%@ Page Title="Reembolso" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Reembolso.aspx.cs" Inherits="Reembolso" %>
...
<ContentTemplate>--%>
 ...
 <center>
  <table width="800px" style="font-family:Verdana, Arial, Helvetica, sans-serif;"> 
   <tr>
    <td width="175px" align="left"><label>Id Reembolso</label></td>
    <td width="225px" align="left"><asp:TextBox ID="txtIdReembolso" runat="server" Width="95%" Enabled="false" ></asp:TextBox></td>
    <td width="175px" align="left"><label>Codigo</label></td>
    <td width="225px" align="left"><asp:TextBox ID="txtCodigoReembolso" runat="server" Width="95%" Enabled="false" ></asp:TextBox></td>
   </tr>
   <tr>   
   ...
   <tr>
    ...
    <td align="left">
     <asp:TextBox ID="txtMontoInicial" runat="server" Width="95%" MaxLength="20" Text="0.00" Enabled="false" ></asp:TextBox>
