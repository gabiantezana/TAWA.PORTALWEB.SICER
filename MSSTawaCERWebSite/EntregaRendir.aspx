<%@ Page Title="EntregaRendir" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EntregaRendir.aspx.cs" Inherits="EntregaRendir" %>
...
<ContentTemplate>
 ...
 <center>
  <table width="800px" style="font-family:Verdana, Arial, Helvetica, sans-serif;"> 
   <tr>
    <td width="175px" align="left"><label>Id Entrega Rendir</label></td>
    <td width="225px" align="left"><asp:TextBox ID="txtIdEntregaRendir" runat="server" Width="95%" Enabled="false" ></asp:TextBox></td>
    <td width="175px" align="left"><label>Codigo</label></td>
    <td width="225px" align="left"><asp:TextBox ID="txtCodigoEntregaRendir" runat="server" Width="95%" Enabled="false" ></asp:TextBox></td>
   </tr>
   <tr>   
   ...
   <tr>   
    ...
    <td align="left"><asp:DropDownList ID="ddlIdMotivo" runat="server" Width="95%" ></asp:DropDownList></td>
   </tr>
   <tr>
   ...
   <tr>    
    ...
    <td align="left" valign="top" colspan="3">
     <asp:TextBox ID="txtMotivoDetalle" runat="server" TextMode="MultiLine" Width="95%" Height="100px" MaxLength="1000" ></asp:TextBox>
 ...
 <center>
  <table width="200px">
   <tr>
    ...
    <td align="center"><asp:Button ID="bCancelar" runat="server" Text="Regresar" CssClass="button" onclick="Cancelar_Click" /></td>
   </tr>
  </table>
 </center>
 <center>
  <table width="450px">
   <tr>
    ...
    <td align="center">
     <asp:Button ID="bRechazar" runat="server" Text="Rechazar" CssClass="button" onclick="Rechazar_Click" />
    ...
    <td align="center"><asp:Button ID="bCancelar2" runat="server" OnClientClick="this.disabled = true; this.value = 'Procesando...';" UseSubmitBehavior="false" OnClick="Cancelar_Click" Text="Regresar" CssClass="button" /></td>
   </tr>
  </table>
 </center>
