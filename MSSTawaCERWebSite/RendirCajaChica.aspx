<%@ Page Title="CajaChicas" EnableEventValidation="false" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="RendirCajaChica.aspx.cs" Inherits="RendirCajaChica" %>
...
<ContentTemplate>
 ...
 <br /> <asp:Label ID="lblIdCajaChicaDocumento" runat="server" Visible="false"></asp:Label><asp:Label ID="lblIdProveedor" runat="server" Visible="false"></asp:Label>
 <table width="1008px">  
  <tr>
 ...
 <table width="1008px">
  ...
  <tr>
   ...
   <td align="left"><asp:DropDownList ID="ddlCentroCostos5" runat="server" Width="95%" OnSelectedIndexChanged="ddlCentroCosto5_SelectedIndexChanged" AutoPostBack="true" ></asp:DropDownList></td>
  </tr>
  <tr>
   <td align="left"><label>Moneda de Caja Chica</label></td>
  ...
  <tr>
   ...
   <td align="left"><label>Importe Total Moneda C.C.</label></td>
   <td align="left">
 ...
 <table width="1008px">
  <tr>
   <td align="center"><asp:Button ID="bAgregar2" runat="server" OnClientClick="this.disabled = true; this.value = 'Procesando...';" UseSubmitBehavior="false" Text="Agregar" CssClass="button" onclick="Agregar2_Click" />
 ...
 <table width="1008px">
  <tr>
   <td width="336px"></td>
   <td width="140px" align="left"><label>Fecha de Contabilizacion:</label></td>
   <td width="196px" align="left">
   ...
   <td align="center">
    <asp:GridView ID="gvCajaChicas" runat="server" 
     ...
     <Columns>
      ...
      <asp:TemplateField HeaderText="Editar" ItemStyle-HorizontalAlign="Center">
       <ItemTemplate>
        <asp:LinkButton ID="lnkEditar" runat="server" CommandName="Editar" CommandArgument='<%#Eval("IdCajaChicaDocumento")%>' > <img src="img/edit.png" alt="Editar" width="20px" /></asp:LinkButton>
       </ItemTemplate>
      </asp:TemplateField>   
      <asp:TemplateField HeaderText="Eliminar" ItemStyle-HorizontalAlign="Center">
       <ItemTemplate>
        <asp:LinkButton ID="lnkEliminar" runat="server" CommandName="Eliminar" CommandArgument='<%#Eval("IdCajaChicaDocumento")%>' > <img src="img/delete.png" alt="Editar" width="20px" /></asp:LinkButton>
       </ItemTemplate>
      </asp:TemplateField> 
 ...
 <table width="1008px">
  <tr>
   ...
   <td width="400px" ><asp:TextBox ID="txtComentario" runat="server" TextMode="MultiLine" Width="95%" Height="50px" MaxLength="1000" ></asp:TextBox></td>
   <td width="254px"></td>
  </tr>
 </table>
 <table width="1008px">
 ...
 <asp:GridView ID="gvReporte" runat="server"
  ...
  <Columns>
   ...
   <asp:BoundField DataField="MontoTotal" HeaderText="Total Caja Chica" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" /> 
   <asp:TemplateField  HeaderText="Moneda" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left">
    <ItemTemplate><%# SetearMoneda(Convert.ToString(Eval("IdMonedaDoc")))%></ItemTemplate>
   </asp:TemplateField>
   <asp:BoundField DataField="MontoNoAfecto" HeaderText="No Afecto" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" /> 
