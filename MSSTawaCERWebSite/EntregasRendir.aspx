<%@ Page Title="EntregasRendir" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EntregasRendir.aspx.cs" Inherits="EntregasRendir" %>
...
<asp:LinkButton ID="lnkNuevaEntregaRendir" runat="server" Font-Underline="false" onclick="lnkNuevaEntregaRendir_Click" > 
     <img src="img/money.png" alt="Nueva Entrega Rendir" width="50px"/><br />Nueva Entrega Rendir
    </asp:LinkButton>
   </td>
   ...
   <td align="center">
    <asp:GridView ID="gvEntregaRendir" runat="server" 
     ...
     <Columns>
      ...
      <asp:BoundField DataField="CodigoEntregaRendir" HeaderText="Codigo" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />
      ...
      <asp:BoundField DataField="MontoReembolsado" HeaderText="Monto Reembolsado" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />   
      ...
      <asp:TemplateField HeaderText="Solicitud" ItemStyle-HorizontalAlign="Center">
       <ItemTemplate>
        <asp:LinkButton ID="lnkSolicitud" runat="server" CommandName="Solicitud" CommandArgument='<%#Eval("IdEntregaRendir")%>' >
      ...
      <asp:TemplateField HeaderText="Aprobacion" ItemStyle-HorizontalAlign="Center">
       <ItemTemplate>
        <asp:LinkButton ID="lnkAprobacion" runat="server" CommandName="Aprobacion" CommandArgument='<%#Eval("IdEntregaRendir")%>' >
      ...
      <asp:TemplateField HeaderText="Rendir" ItemStyle-HorizontalAlign="Center">
       <ItemTemplate>
        <asp:LinkButton ID="lnkRendir" runat="server" CommandName="Rendir" CommandArgument='<%#Eval("IdEntregaRendir")%>' >
...
<%--      <asp:TemplateField HeaderText="Detalle" ItemStyle-HorizontalAlign="Center">
       <ItemTemplate>
        <asp:LinkButton ID="lnkDetalle" runat="server" CommandName="Detalle" CommandArgument='<%#Eval("IdEntregaRendir")%>' >
         <img src="img/detail.png" alt="Editar" width="20px" />
        </asp:LinkButton>
       </ItemTemplate>
      </asp:TemplateField> --%>
