...
{
    public class EntregaRendirBE
    {
        int _IdEntregaRendir;
        String _CodigoEntregaRendir;
        int _IdEmpresa;
        int _IdArea;
        ...
        public String CodigoEntregaRendir
        {
            get { return _CodigoEntregaRendir; }
            set { _CodigoEntregaRendir = value; }
        }
